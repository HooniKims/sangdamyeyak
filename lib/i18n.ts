...
const translations: Record<Language, Record<string, string>> = {
    ko: {
        ...
        homeroomReservationHint: '기존 방식대로 담임 교사를 자동 매칭해 가능한 시간 슬롯을 예약합니다.',
        nonHomeroomReservation: '비담임 상담',
        nonHomeroomReservationHint: '학교에 등록된 비담임 교사를 직접 선택하고 희망 일시와 내용을 남깁니다.',
        studentNumber: '학번',
    ...
    en: {
        ...
        homeroomReservationHint: 'Keep the current flow and reserve an available slot with the matched homeroom teacher.',
        nonHomeroomReservation: 'Non-homeroom Counseling',
        nonHomeroomReservationHint: 'Choose a registered non-homeroom teacher and leave your preferred date, time, and request details.',
