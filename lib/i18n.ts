...
const translations: Record<Language, Record<string, string>> = {
    ko: {
        ...
        // ── 메인 페이지 ──
        smartSchoolPlatform: '상담 예약 플랫폼',
        mainSubtitle: '학부모 상담 일정을 빠르게 조율하고,',
        mainSubtitle2: '예약과 조회를 한 곳에서 간편하게 관리하세요.',
        teacherUse: '교사용',
        parentUse: '학부모용',
        counseling: '상담 예약',
        ...
        teacherWelcome: '상담 가능 시간을 설정하고 예약 현황을 관리해보세요.',
        parentWelcome: '원하는 시간으로 상담을 예약하고 예약 내역을 확인해보세요.',
        firstVisit: '처음 방문하셨나요?',
        firstVisitTeacher: '교사',
        firstVisitTeacherDesc: '는 상담 시간을 설정하고 예약 현황을 관리할 수 있습니다.',
        firstVisitParent: '학부모',
        firstVisitParentDesc: '님은 상담을 예약하고 예약 내역을 조회할 수 있습니다.',
        footer: '© 2026 상담 예약 도우미. Powered by HooniKim',
        privacyPolicy: '개인정보처리방침',
        changePassword: '비밀번호 변경',
        myInfo: '내 정보',
        editSchoolGradeClass: '학교/학년/반 변경',
        monthlyTeacherProfileTitle: '교사 정보 확인',
        monthlyTeacherProfileNotice: '등록된 학교, 학년, 반이 현재 정보와 맞는지 확인해주세요. 교사 정보는 30일마다 한 번씩 확인합니다.',
        teacherProfileUpdateHint: '학교나 학년·반을 변경하면 연결된 학부모와 상담 요청의 담임 매칭이 새 정보에 맞게 정리됩니다.',
        teacherProfileUpdated: '학교/학년/반 정보가 저장되었습니다.',
        confirmAndSave: '맞습니다 · 저장',
        ...
        selectSchoolFromSearch: '리스트에서 학교를 선택해주세요.',
        tooManyRequests: '너무 많은 시도가 있었습니다. 잠시 후 다시 시도해주세요.',
        loginFailed: '로그인에 실패했습니다. 다시 시도해주세요.',
        networkUnavailable: '네트워크 연결 또는 서비스워커 문제로 로그인에 실패했습니다. 새로고침 후 다시 시도해주세요.',
        firebaseConfigMissing: 'Firebase 환경변수가 설정되지 않았습니다. `.env.local`을 확인한 뒤 개발 서버를 다시 시작해주세요.',
        ...
        teacherDesc: '상담 시간 설정, 예약 관리',
        parentDesc: '상담 예약, 예약 조회',
        orDivider: '또는',
        ...
        signupNonHomeroomHint: '담임이 아닌 교사로 등록합니다.',
        nonHomeroomSignupNoSlotHint: '비담임으로 가입하면 상담 가능 시간은 설정하지 않고, 직접 신청된 상담 요청만 확인합니다.',
        ...
        selectAllReservations: '전체 선택',
        completeReservation: '상담 완료',
        completeReservationTitle: '상담 완료 처리',
        confirmBulkCompleteReservations: '선택한 {count}건의 상담을 완료 처리하시겠습니까?',
        selectReservationsToComplete: '완료 처리할 상담을 선택해주세요.',
        confirmBulkCancelReservations: '선택한 {count}건의 예약을 취소하시겠습니까?',
        bulkCancelError: '일괄 취소 중 오류가 발생했습니다.',
        reservationsCanceled: '선택한 예약이 취소되었습니다.',
        reservationsCompleted: '선택한 상담을 완료 처리했습니다.',
        reservationCompleted: '상담 완료',
        markReservationComplete: '상담 완료',
        undoReservationCompletion: '완료 해제',
        reservationCompletionUpdateFailed: '상담 완료 상태 변경에 실패했습니다.',
        editReservation: '예약 변경',
        closeEditReservation: '변경 닫기',
        cancelEditReservation: '수정 취소',
        saveReservationEdit: '변경 저장',
        savingReservationEdit: '저장 중...',
        reservationUpdated: '예약 변경이 반영되었습니다.',
        reservationUpdateFailed: '예약 변경에 실패했습니다.',
        editedReservationSlot: '예약 시간',
        selectEditedReservationSlot: '변경할 예약 시간을 선택해주세요.',
        nonHomeroom: '비담임',
        nonHomeroomHint: '비담임 선생님은 상담 예약 기능을 사용할 수 없습니다.',
        nonHomeroomDashboardDesc: '비담임으로 접수된 상담 요청을 확인하세요.',
        nonHomeroomTeacherPageHint: '비담임 교사는 시간 슬롯을 설정하지 않고, 학부모가 직접 남긴 희망 상담 요청만 확인합니다.',
        nonHomeroomRequests: '비담임 신청 목록',
        nonHomeroomRequestsDesc: '학부모가 직접 비담임으로 지정해 남긴 상담 요청입니다.',
        classNonHomeroomRequests: '우리 반 비담임 신청',
        classNonHomeroomRequestsDesc: '본인 반 학생이 다른 비담임 교사에게 신청한 내용입니다.',
        noNonHomeroomRequests: '접수된 비담임 신청이 없습니다.',
        desiredDateTime: '희망일시',
        desiredTeacher: '희망교사',
        ...
        homeroomReservation: '담임 상담',
        homeroomReservationHint: '담임 교사를 자동 매칭해 가능한 시간 슬롯을 예약합니다.',
        nonHomeroomReservation: '비담임 상담',
        nonHomeroomReservationHint: '비담임 교사를 직접 입력하고 희망 일시와 내용을 남깁니다.',
        studentNumber: '학번',
        studentNumberPlaceholder: '학번을 입력하세요',
        studentNameField: '자녀 성명',
        studentNameFieldPlaceholder: '자녀 이름을 입력하세요',
        ...
        requestSummary: '신청 요약',
        selectPreferredDateTime: '희망 날짜와 시간을 선택해 주세요.',
        selectDesiredTeacher: '희망 교사를 선택해 주세요.',
        selectPreferredDate: '희망 날짜를 선택해 주세요.',
        selectPreferredTime: '희망 시간을 선택해 주세요.',
        enterNonHomeroomContent: '상담 내용을 입력해 주세요.',
        nonHomeroomCounselingContent: '상담 내용',
        nonHomeroomContentPlaceholder: '희망 상담 주제나 전달할 내용을 자세히 적어 주세요.',
        submitNonHomeroomRequest: '비담임 상담 신청하기',
        nonHomeroomDirectRequestNotice: '비담임 상담은 원하는 교사와 희망 일시를 직접 입력해 신청합니다.',
        nonHomeroomRequestCompleted: '비담임 상담 신청 완료',
        nonHomeroomRequestCompletedMsg: '희망 상담 요청이 접수되었습니다.\n교사가 확인한 뒤 별도로 안내할 수 있습니다.',
        nonHomeroomRequestFailed: '비담임 상담 신청에 실패했습니다. 잠시 후 다시 시도해 주세요.',
        ...
        deleteCompletedDesc: '그동안 상담 예약 도우미를 이용해주셔서',
    ...
    en: {
        // ── Common ──
        schoolholic: 'Counseling Booking Assistant',
        login: 'Login',
        logout: 'Logout',
        signup: 'Sign Up',
        teacher: 'Teacher',
        ...
        // ── Main Page ──
        smartSchoolPlatform: 'Counseling Booking Platform',
        mainSubtitle: 'Coordinate parent counseling schedules quickly,',
        mainSubtitle2: 'and manage bookings and lookup in one place.',
        ...
        teacherWelcome: 'Set available counseling hours and manage reservations.',
        parentWelcome: 'Book counseling sessions and review reservation history.',
        firstVisit: 'First time here?',
        firstVisitTeacher: 'Teachers',
        firstVisitTeacherDesc: ' can set counseling hours and manage reservations.',
        firstVisitParent: 'Parents',
        firstVisitParentDesc: ' can book counseling sessions and review reservations.',
        footer: '© 2026 Counseling Booking Assistant. Powered by HooniKim',
        privacyPolicy: 'Privacy Policy',
        changePassword: 'Change Password',
        myInfo: 'My Info',
        editSchoolGradeClass: 'Update School/Grade/Class',
        monthlyTeacherProfileTitle: 'Confirm Teacher Information',
        monthlyTeacherProfileNotice: 'Please confirm that your registered school, grade, and class are current. Teacher information is reviewed once every 30 days.',
        teacherProfileUpdateHint: 'Changing your school, grade, or class will refresh linked parent and counseling-request matches using the new information.',
        teacherProfileUpdated: 'Your school, grade, and class have been saved.',
        ...
        networkUnavailable: 'Login failed because the network or service worker blocked Firebase. Refresh and try again.',
        firebaseConfigMissing: 'Firebase environment variables are missing. Check `.env.local` and restart the dev server.',
        ...
        teacherDesc: 'Set hours, manage reservations',
        parentDesc: 'Book counseling, check reservations',
        orDivider: 'or',
        ...
        signupNonHomeroomHint: 'Register this account as a non-homeroom teacher.',
        nonHomeroomSignupNoSlotHint: 'Non-homeroom teachers do not open time slots. They only review direct counseling requests.',
        ...
        selectAllReservations: 'Select All',
        completeReservation: 'Mark Counseling Complete',
        completeReservationTitle: 'Mark Counseling Complete',
        confirmBulkCompleteReservations: 'Mark {count} selected counseling session(s) as complete?',
        selectReservationsToComplete: 'Select counseling session(s) to mark as complete.',
        confirmBulkCancelReservations: 'Cancel {count} selected reservation(s)?',
        bulkCancelError: 'Error during bulk cancel.',
        reservationsCanceled: 'Selected reservations canceled.',
        reservationsCompleted: 'Selected counseling session(s) marked as complete.',
        reservationCompleted: 'Completed',
        markReservationComplete: 'Mark Complete',
        undoReservationCompletion: 'Undo Complete',
        reservationCompletionUpdateFailed: 'Failed to update reservation completion state.',
        editReservation: 'Edit Reservation',
        closeEditReservation: 'Close Edit',
        cancelEditReservation: 'Cancel Edit',
        saveReservationEdit: 'Save Changes',
        savingReservationEdit: 'Saving...',
        reservationUpdated: 'Reservation changes saved.',
        reservationUpdateFailed: 'Failed to update the reservation.',
        editedReservationSlot: 'Reservation Time',
        selectEditedReservationSlot: 'Please select the new reservation time.',
        nonHomeroom: 'Non-homeroom',
        nonHomeroomHint: 'Non-homeroom teachers cannot use the reservation system.',
        nonHomeroomDashboardDesc: 'Review counseling requests sent directly to non-homeroom teachers.',
        nonHomeroomTeacherPageHint: 'Non-homeroom teachers do not create time slots. They review direct requests submitted by parents.',
        nonHomeroomRequests: 'Direct Non-homeroom Requests',
        nonHomeroomRequestsDesc: 'Requests submitted directly to a non-homeroom teacher.',
        classNonHomeroomRequests: 'Class Requests to Non-homeroom Teachers',
        classNonHomeroomRequestsDesc: 'Requests your class students submitted to other non-homeroom teachers.',
        noNonHomeroomRequests: 'No non-homeroom requests have been submitted.',
        desiredDateTime: 'Preferred Date/Time',
        desiredTeacher: 'Preferred Teacher',
        ...
        homeroomReservation: 'Homeroom Counseling',
        homeroomReservationHint: 'Reserve an available slot with the matched homeroom teacher.',
        nonHomeroomReservation: 'Non-homeroom Counseling',
        nonHomeroomReservationHint: 'Enter a non-homeroom teacher and leave your preferred date, time, and request details.',
        studentNumber: 'Student ID',
        studentNumberPlaceholder: 'Enter student ID',
        studentNameField: "Child's Name",
        studentNameFieldPlaceholder: "Enter child's name",
        ...
        selectPreferredDateTime: 'Choose your preferred date and time.',
        selectDesiredTeacher: 'Please choose a teacher.',
        selectPreferredDate: 'Please choose a preferred date.',
        selectPreferredTime: 'Please choose a preferred time.',
        enterNonHomeroomContent: 'Please enter the counseling details.',
        nonHomeroomCounselingContent: 'Counseling Details',
        nonHomeroomContentPlaceholder: 'Describe the topic or details you want to discuss with the teacher.',
        submitNonHomeroomRequest: 'Submit Non-homeroom Request',
        nonHomeroomDirectRequestNotice: 'For non-homeroom counseling, choose the teacher and enter your preferred date, time, and details directly.',
        nonHomeroomRequestCompleted: 'Non-homeroom Request Submitted',
        nonHomeroomRequestCompletedMsg: 'Your request has been submitted.\nThe teacher may contact you separately after review.',
        nonHomeroomRequestFailed: 'Failed to submit the non-homeroom request. Please try again later.',
        ...
        deleteCompletedDesc2: 'Counseling Booking Assistant.',
