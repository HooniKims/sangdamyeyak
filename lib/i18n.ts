...
const translations: Record<Language, Record<string, string>> = {
    ko: {
        ...
        completeReservation: '예약 완료',
        completeReservationTitle: '예약 완료 처리',
        confirmBulkCompleteReservations: '선택한 {count}건의 예약을 완료 처리하시겠습니까?',
        selectReservationsToComplete: '완료 처리할 예약을 선택해주세요.',
        ...
        reservationsCompleted: '선택한 예약을 완료 처리했습니다.',
    ...
    en: {
        ...
        completeReservation: 'Mark Complete',
        completeReservationTitle: 'Mark Reservation Complete',
        confirmBulkCompleteReservations: 'Mark {count} selected reservation(s) as complete?',
        selectReservationsToComplete: 'Select reservation(s) to mark as complete.',
        ...
        reservationsCompleted: 'Selected reservations marked as complete.',
