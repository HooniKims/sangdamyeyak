...
const translations: Record<Language, Record<string, string>> = {
    ko: {
        ...
        cancelReservationMessage: '{name}({number})의 예약을 취소하시겠습니까?',
        ...
        enterBothFields: '학번과 이름을 모두 입력해 주세요.',
        enterStudentInfo: '학번과 이름을 입력해 주세요.',
        editInfo: '정보 수정',
        selectTimeSlot: '상담 시간을 선택하세요',
        selectAvailableTime: '상담 가능한 시간을 선택하세요',
        noAvailableTime: '예약 가능한 시간이 없습니다.',
        noTimeSlots: '표시할 미래 상담 시간이 없습니다.',
    ...
    en: {
        ...
        cancelReservationMessage: "Cancel {name}({number})'s reservation?",
        ...
        enterBothFields: 'Please enter both student ID and name.',
        enterStudentInfo: 'Please enter the student ID and name.',
        editInfo: 'Edit Info',
